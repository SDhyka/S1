...
【 *BOT INFO* 】
 ...
 • 𝖡𝗈𝗍 𝖭𝖺𝗆𝖾 : ${botName} ✅️
 • 𝖶𝖺𝗄𝗍𝗎 : ${jam} 𝖶𝖨𝖡 🕛
 • 𝖳𝖺𝗇𝗀𝗀𝖺𝗅 : ${tanggal(new Date())} 🧭
 • 𝖱𝗎𝗇𝖳𝗂𝗆𝖾 : ${runtime(process.uptime())} ⏳️

*USER INFO*
 • 𝖭𝖺𝗆𝖾 : *${pushname !== undefined ? pushname : '-'}* ✨️
 • 𝖲𝗍𝖺𝗍𝗎𝗌 : ${isCreator ? 'Owner' : isPremium ? '*Premium*' : 'Free'} 🧿
 • 𝖫𝗂𝗆𝗂𝗍 : ${isCreator ? 'Unlimited' : isPremium ? 'Unlimited' : getLimit(sender, limitCount, limit)} 🃏
 • 𝖫𝗂𝗆𝗂𝗍 𝖦𝖺𝗆𝖾 : ${isCreator ? 'Unlimited' : cekGLimit(sender, gcount, glimit)} 🎮
 • 𝖡𝖺𝗅𝖺𝗇𝖼𝖾 : *${toCommas(getBalance(sender, balance))}* 💵
